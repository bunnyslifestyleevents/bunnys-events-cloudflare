...
import { signup, setToken } from '@/lib/client/authClient'
  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <form onSubmit={handleSubmit} className="p-6 rounded shadow-md w-full max-w-md">
        ...
        <button className="w-full bg-blue-600 text-white p-2" disabled={loading}>{loading ? 'Creating...' : 'Create account'}</button>
      </form>
    </div>
  )
}
